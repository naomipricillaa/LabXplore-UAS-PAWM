...
export default function Material() {
  ...
  const checkAnswers = () => {
    const newCheckStatus: ProblemState = {
      problem1:
        selectedAnswers.problem1 === correctAnswers.problem1
          ? "correct"
          : "incorrect",
      problem2:
        selectedAnswers.problem2 === correctAnswers.problem2
          ? "correct"
          : "incorrect",
      problem3:
        selectedAnswers.problem3 === correctAnswers.problem3
          ? "correct"
          : "incorrect",
    };
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={[styles.card, styles.orangeCard]}>
          <Text style={styles.descriptionText}>
            ...
            thermodynamics, we study how a system's temperature, volume,
            pressure and mass affect each other. One of the fundamental
            equations in thermodynamics is the Ideal Gas Law. The Ideal Gas Law
            describes the relationship between the various gas parameters (P, V,
            temperature T) and amount of substance (n).
          </Text>
          <Text style={styles.descriptionText}>
            This law helps us understand how gases behave under different
            conditions, including changes in temperature. It is particularly
            useful for performing calculations in chemistry and physics, such as
        ...
        <View style={styles.problemCard}>
          <Text style={styles.problemText}>
            If the temperature of an ideal gas increases from 300 K to 600 K
            while keeping the volume constant, what happens to the pressure?
          </Text>
          <View style={styles.optionsContainer}>
            {["Doubles", "Same", "Decreases", "Increases"].map((option) => (
              ...
              >
                <Text style={getOptionTextStyle("problem1", option)}>
                  {option}
                </Text>
              </TouchableOpacity>
            ))}
        ...
        <View style={styles.problemCard}>
          <Text style={styles.problemText}>
            A sealed container holds 1.5 moles of an ideal gas at a volume of
            0.03 m³ and a temperature of 300 K. What is the pressure of the gas
            inside the container in Pascals (Pa)?
          </Text>
          <View style={styles.optionsContainer}>
            {["123,210 Pa", "124,710 Pa", "121,470 Pa", "122,210 Pa"].map(
              (option) => (
                <TouchableOpacity
                  key={option}
                ...
                >
                  <Text style={getOptionTextStyle("problem2", option)}>
                    {option}
                  </Text>
                </TouchableOpacity>
              )
        ...
        <View style={styles.problemCard}>
          <Text style={styles.problemText}>
            An ideal gas is contained in a 0.05 m³ container, with 2 moles of
            gas at a temperature of 350 K. What is the pressure of the gas
            inside the container in Pascals (Pa)?
          </Text>
          <View style={styles.optionsContainer}>
            {["116,396 Pa", "115,396 Pa", "117,498 Pa", "118,650 Pa"].map(
              (option) => (
                <TouchableOpacity
                  key={option}
                ...
                >
                  <Text style={getOptionTextStyle("problem3", option)}>
                    {option}
                  </Text>
                </TouchableOpacity>
              )
